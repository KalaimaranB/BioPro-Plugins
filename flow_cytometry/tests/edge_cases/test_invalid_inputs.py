...
class TestBoundaryConditions:
    ...
    def test_range_gate_at_boundaries(self):
        ...
        gate = RangeGate('FITC-A', y_min=100, y_max=200)
...
class TestExtremeValues:
    ...
    def test_gate_with_very_small_values(self):
        ...
        gate = RectangleGate('FSC-A', 'SSC-A', 1, 1000, 0.1, 100)
    ...
    def test_negative_values_in_data(self):
        ...
        gate = RectangleGate('FSC-A', 'SSC-A', -100, 200_000, -50, 50_000)
...
class TestZeroWidthGates:
    ...
    def test_range_zero_width(self):
        ...
        gate = RangeGate('FITC-A', y_min=100, y_max=100)
...
class TestQuadrantEdgeCases:
    ...
    def test_quadrant_threshold_at_extreme(self):
        ...
        gate = QuadrantGate('FITC-A', 'PE-A', x_threshold=0, y_threshold=0)
    ...
    def test_quadrant_with_identical_values(self):
        ...
        gate = QuadrantGate('FITC-A', 'PE-A', x_threshold=100, y_threshold=100)
...
class TestLargeDataHandling:
    ...
    def test_many_sequential_gates_on_large_data(self, sample_a_events):
        ...
        gates = [
            RectangleGate('FSC-A', 'SSC-A', 30_000 + i*5_000, 220_000 - i*5_000, 100, 60_000)
            for i in range(20)
        ]
